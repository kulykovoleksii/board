...
export default function Show({ category, attributes, parentAttributes }) {
    const handleDelete = () => {
        if (confirm('Are you sure you want to delete this category?')) {
            router.delete(`/admin/adverts/categories/${category.id}`);
        }
    };

    const handleDeleteAttribute = (attributeId) => {
        if (confirm('Are you sure you want to delete this attribute?')) {
            router.delete(`/admin/adverts/categories/${category.id}/attributes/${attributeId}`, {
                preserveScroll: true,
            });
        }
    };
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <Link
                            href={`/admin/adverts/categories/${category.id}/attributes/create`}
                    ...
                    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {/* Parent Attributes */}
                                {parentAttributes && parentAttributes.length > 0 && (
                                    <>
                                        <tr className="bg-gray-50">
                                            <th colSpan={5} className="px-6 py-3 text-left text-sm font-semibold text-gray-700">
                                                Parent Attributes
                                            </th>
                                        </tr>
                                        {parentAttributes.map((attribute) => (
                                            <tr key={`parent-${attribute.id}`} className="bg-gray-50">
